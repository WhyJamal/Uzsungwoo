  ...
  <div class="p-2 bg-white/50">
    ...
    <transition name="fade">
      <div v-if="isVisible" class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div
          class="flex items-center justify-between bg-white rounded-lg shadow-sm p-4 hover:shadow-md transition"
        >
          <div class="flex flex-col justify-center text-center w-full">
            <span class="text-gray-700 text-sm font-medium">Продажи</span>
            <span class="text-xs text-gray-400">Orders</span>
            <span class="text-xl font-bold text-gray-800 mt-1">2403</span>
          </div>
          <div class="bg-sky-100 text-sky-600 p-2 rounded-md ml-3">
            <svg
              class="w-6 h-6"
              fill="none"
              viewBox="0 0 24 24"
        ...
        >
          ...
          <div class="bg-yellow-100 text-yellow-600 p-2 rounded-md ml-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-6 h-6"
              fill="none"
            ...
            >
              <path
                ...
                stroke-width="2"
                d="M3 3v18h18M7 13v6M12 9v10M17 5v14"
              />
            </svg>
          </div>
        </div>
